<?php 
  ...
  $ok= "";
    ...
    $date = date('Y-m-d', $time_1);

    if(isset($_GET['date'])){
        $id_room = $_GET['date'];
        $queryDate = "UPDATE tbl_rooms SET 	time_stop = :time_stop WHERE id = :id";
